    ...
    <footer className='w-full h-[300px] bg-[#F1F5F9] px-[50px] 2xl:px-[90px] flex flex-col justify-center items-center text-[#142e38]'>
      <div className='flex w-full h-full py-11 justify-center items-center'>
        ...
        <ul className='w-full h-full flex flex-col justify-between items-start gap-3'>
          ...
          <Link href='#' className='text-[18px] font-light hover:underline hover:underline-offset-2'>ESPACIOS</Link>
          <Link href='#' className='text-[18px] font-light hover:underline hover:underline-offset-2'>UBICACIÓN</Link>
          <Link href='#' className='text-[18px] font-light hover:underline hover:underline-offset-2'>CONTACTO</Link>
        </ul>
        <ul className='w-full h-full flex flex-col justify-between items-start gap-3'>
          <h4 className='text-[20px] font-semibold'>SERVICIOS</h4>
          <Link href='#' className='text-[18px] font-light hover:underline hover:underline-offset-2'>COWORKING</Link>
          <Link href='#' className='text-[18px] font-light hover:underline hover:underline-offset-2'>PRIVADO</Link>
          <Link href='#' className='text-[18px] font-light hover:underline hover:underline-offset-2'>OFICINA VIRTUAL</Link>
          <Link href='#' className='text-[18px] font-light hover:underline hover:underline-offset-2'>SALA DE JUNTAS</Link>
        </ul>
