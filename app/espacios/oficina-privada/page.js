                ...
                >
                  <div className='w-full h-[550px] flex justify-center items-center'>
                    <Image
                      ...
                      priority
                    />
                    <p className='absolute bottom-12 rounded-lg py-1.5 px-6 bg-[#142e38] text-[#f0fbfb]'>Espacio 1</p>
                  </div>
                  <div className='w-full h-[550px] flex justify-center items-center'>
                    <Image
                      className='w-full h-full object-cover object-center'
                      ...
                      src={Desk}
                    />
                    <p className='absolute bottom-12 rounded-lg py-1.5 px-6 bg-[#142e38] text-[#f0fbfb]'>Espacio 2</p>
                  </div>
                  <div className='w-full h-[550px] flex justify-center items-center'>
                    <Image
                      className='w-full h-full object-cover object-center'
                      ...
                      src={Desk}
                    />
                    <p className='absolute bottom-12 rounded-lg py-1.5 px-6 bg-[#142e38] text-[#f0fbfb]'>Espacio 3</p>
                  </div>
                </Carousel>
              </div>
            </div>
