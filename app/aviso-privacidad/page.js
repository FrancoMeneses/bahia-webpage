  ...
  return (
    <main className='font-text py-6 px-4 md:px-[50px] 2xl:px-[90px] flex flex-col w-full h-auto gap-4'>
      ...
      <div className='text-justify flex flex-col w-full h-full gap-4'>
        <p>
          Bahía Business Center, con domicilio en Av. Rojo Gómez 595 Esquina Bugambilias Chetumal, Quintana Roo y portal de internet bahiabusinesscenter.com.mx, es el responsable del uso y protección de sus datos personales, y al respecto le informamos lo siguiente:
        </p>
        ...
        <p>
          Para el ejercicio de cualquiera de los derechos ARCO, debe enviar una petición vía correo electrónico a bahia.business.c@gmail.com y deberá contener:
        </p>
        <ul className='list-disc list-inside'>
